...
int main()
{
    ...
    cout << " Recorriendo todos los elementos " << endl;
    agenda.listarPersonasQueCumplen2(f);
    cout << endl;

    cout << " Recorriendo por limite inferior y superior del valor dado " << endl;
    agenda.listarPersonasQueCumplen3(f);
    cout << " ---------FIN--------- " << endl;
    return 0;
}
