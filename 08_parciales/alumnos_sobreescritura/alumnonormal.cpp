...
AlumnoNormal::AlumnoNormal(int dni, char * nombres,   char * apellido, int p1, int p2, int p3, int final): Alumno(dni, nombres,  apellido)
{
    this->p1 = p1;
    this->p2 = p2;
    this->p3 = p3;
...
char *AlumnoNormal::getCondicion() const
{
